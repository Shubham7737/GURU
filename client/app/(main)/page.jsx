        ...
        <div className="container hero-container">
          ...
          >
            ...
            <div className="hero-btns">
              <button className="btn btn-primary btn-lg" onClick={() => router.push(isLoggedIn ? '/dashboard' : '/signup')}>
          ...
          >
            ...
            <img 
              src="https://images.pexels.com/photos/37758744/pexels-photo-37758744.jpeg" 
      ...
      <section className="final-cta">
        <div className="container text-center">
          ...
          <div className="cta-btns">
            <button className="btn btn-primary btn-lg" onClick={() => router.push('/signup')}>Get Started for Free</button>
